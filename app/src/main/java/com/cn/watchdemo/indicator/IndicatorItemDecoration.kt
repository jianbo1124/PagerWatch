...
import com.cn.watchdemo.indicator.shape.IndicatorShape
...
class IndicatorItemDecoration : RecyclerView.ItemDecoration() {
     ...
     */
    private var topOffset = 4.toDP().toInt()

    /**
     * Bottom Offset in View
     */
    private var bottomOffset = 4.toDP().toInt()

    /**
     * Padding between indicators.
     */
    private var indicatorItemPadding = 8.toDP()

    /**
     * Indicator shape
     */
    private var isOverlap: Boolean = true
